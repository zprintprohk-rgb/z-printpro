...
// ============================================================================
// 模拟数据服务（不从 @/lib/supabase 导入 Order 类型）
// ============================================================================
const getOrderById = async (id: string): Promise<Order | null> => {
  // TODO: 替换为实际 API 调用
  // 示例：import { getOrderById as fetchOrder } from '@/lib/supabase'; return fetchOrder(id);
...
const statusConfig: Record<OrderStatus, { label: string; color: string; bg: string; icon: any }> = {
  ...
  REFUNDED: { label: '已退款', color: 'text-gray-800', bg: 'bg-gray-100', icon: XCircle },
}
...
const carriers = [
  ...
  { value: 'DHL', label: 'DHL' },
  { value: 'YTO', label: '圓通速遞' },
  { value: 'ZTO', label: '中通快遞' },
]
